...
wires TheHive → Cortex (and writes integrations/thehive/application.conf), this script wires
...
# The webhook ENDPOINT ('local') is declared in integrations/thehive/application.conf
