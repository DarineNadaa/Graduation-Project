    ...
    <div className={`relative h-full w-full p-1${className ? ' ' + className : ''}`}>
      ...
      <div
        style={{
          ...
          inset: 0,
          zIndex: 1,
          backdropFilter: blurIntensity !== '0px' ? `blur(${blurIntensity})` : undefined,
          backgroundImage: `radial-gradient(circle at 50% 50%, transparent 0, transparent 3px, ${backgroundColor}cc 3px)`,
